...
enum MenuSettings {
    ...
    SETTINGMENU_RADIO_HARDAI = 3,
    SETTINGMENU_RADIO_MYSTUFF = 4,
...
enum ThemeSettings {
    SETTINGTHEME_RADIO_INPUT = 0,
    SETTINGTHEME_RADIO_PRESET = 1,
    SETTINGTHEME_RADIO_DIRECTION = 2,
    SETTINGTHEME_RADIO_CUSTOMTEXTURES = 3,
    SETTINGTHEME_SCROLL_COLOUR1 = 1 + 6,
    SETTINGTHEME_SCROLL_COLOUR2 = 0 + 6,
};

//THEME SETTINGS
enum ThemeSettingInput {
    THEMESETTING_INPUT_DISABLED,
    THEMESETTING_INPUT_ENABLED,
    THEMESETTING_INPUT_FORCED
};

enum ThemeSettingPreset {
    THEMESETTING_PRESET_LIMITLESS,
    THEMESETTING_PRESET_UNLIMITED,
    THEMESETTING_PRESET_BLAZINGCOLD,
    THEMESETTING_PRESET_CUSTOM
};

enum ThemeSettingDirection {
    THEMESETTING_DIRECTION_VERTICAL,
    THEMESETTING_DIRECTION_HORIZONTAL,
    THEMESETTING_DIRECTION_DIAGONAL
};

enum ThemeSettingCustomTextures {
    THEMESETTING_CUSTOMTEXTURES_ENABLED = 0x0,
    THEMESETTING_CUSTOMTEXTURES_DISABLED = 0x1
};

enum ThemeSettingColour {
    THEMESETTING_COLOUR_BLACK,
    THEMESETTING_COLOUR_BLUE,
    THEMESETTING_COLOUR_BROWN,
    THEMESETTING_COLOUR_CYAN,
    THEMESETTING_COLOUR_GREY,
    THEMESETTING_COLOUR_GREEN,
    THEMESETTING_COLOUR_LIGHTBLUE,
    THEMESETTING_COLOUR_LIME,
    THEMESETTING_COLOUR_MAGENTA,
    THEMESETTING_COLOUR_ORANGE,
    THEMESETTING_COLOUR_PINK,
    THEMESETTING_COLOUR_PURPLE,
    THEMESETTING_COLOUR_RED,
    THEMESETTING_COLOUR_TEAL,
    THEMESETTING_COLOUR_WHITE,
    THEMESETTING_COLOUR_YELLOW
};
...
enum MenuSettingMyStuff {
    MENUSETTING_MYSTUFF_OFF,
    MENUSETTING_MYSTUFF_1,
    MENUSETTING_MYSTUFF_2,
    MENUSETTING_MYSTUFF_3
};
