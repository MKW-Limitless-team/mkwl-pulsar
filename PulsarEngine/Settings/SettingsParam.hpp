...
enum InputSettings {
    SETTINGINPUT_RADIO_INPUT = 0,
    SETTINGINPUT_RADIO_PRESET = 1,
    SETTINGINPUT_RADIO_DIRECTION = 2,
    SETTINGINPUT_SCROLL_COLOUR1 = 0 + 6,
    SETTINGINPUT_SCROLL_COLOUR2 = 1 + 6,
};

//INPUT SETTINGS
enum InputSettingInput {
    INPUTSETTING_INPUT_DISABLED,
    INPUTSETTING_INPUT_ENABLED,
    INPUTSETTING_INPUT_FORCED
};

enum InputSettingPreset {
    INPUTSETTING_PRESET_LIMITLESS,
    INPUTSETTING_PRESET_UNLIMITED,
    INPUTSETTING_PRESET_BLAZINGCOLD,
    INPUTSETTING_PRESET_CUSTOM
};

enum InputSettingDirection {
    INPUTSETTING_DIRECTION_VERTICAL,
    INPUTSETTING_DIRECTION_HORIZONTAL,
    INPUTSETTING_DIRECTION_DIAGONAL
};

enum InputSettingColour {
    INPUTSETTING_COLOUR_BLACK,
    INPUTSETTING_COLOUR_BLUE,
    INPUTSETTING_COLOUR_BROWN,
    INPUTSETTING_COLOUR_CYAN,
    INPUTSETTING_COLOUR_GREY,
    INPUTSETTING_COLOUR_GREEN,
    INPUTSETTING_COLOUR_LIME,
    INPUTSETTING_COLOUR_MAGENTA,
    INPUTSETTING_COLOUR_ORANGE,
    INPUTSETTING_COLOUR_PINK,
    INPUTSETTING_COLOUR_PURPLE,
    INPUTSETTING_COLOUR_RED,
    INPUTSETTING_COLOUR_VIOLET,
    INPUTSETTING_COLOUR_WHITE,
    INPUTSETTING_COLOUR_YELLOW
};
